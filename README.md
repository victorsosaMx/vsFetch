...
> Prefer a GUI? **[vsFetch Settings](https://github.com/victorsosaMx/vsFetch-Settings)** is a graphical editor that covers all options below — install it with `yay -S vsfetch-settings`.
